...
<body>
    ...
    <div id='header'><h1>BLOODBANK</h1></div>
    <div id='html_pages'>
        <a href="blood storage disp.php">AVAILABLE BLOOD IN STORAGE</a><br><br>

        <a href="camps.html">CREATE NEW CAMP</a><br>
        ...
        <a href="receiver variable disp.php">RECEIVE BLOOD</a><br>
    </div>
</body>
